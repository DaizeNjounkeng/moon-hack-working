...
"J: A picture of your favorite person on earth"
]

print("It is the year 3000. You are on a solo mission to restock the base on the moon with soil and seeds to grow more plants.")
...
if "J" not in user_list:
  print("We all have that one special person, but sorry, they won't save you this time")
...
print("It's time to return to EARTH!")